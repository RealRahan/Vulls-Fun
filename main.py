...
@commands.guild_only()
@commands.has_permissions(manage_messages=True)
async def verify(ctx,*, user: discord.Member=None, r="لم يتم تحديد رسالة"):
 if ctx.channel.id == 987012780102123540:
  ...
  await user.send("**السلام عليكم ورحمه الله وبركاته انا بوت فولز للمتعة\nتم توثيقك من الأدارة\nرسالة لك منهم: {r}\nاستمتع**")
 else:
  return
