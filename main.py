...
async def azkar():
 ...
 a.set_thumbnail(url="https://media.discordapp.net/attachments/987969477348040757/988840303974809630/1_5f7250ba05c4e_1601327290_1573947751.png")
...
@commands.guild_only()
async def ping(ctx):
  msg=await ctx.send(f"**{round(client.latency * 1000)}ms**")
  while True:
   time.sleep(1)
   await msg.edit(content=f"**{round(client.latency * 1000)}ms**")
...
**""")
  ...
  time.sleep(2)
  await ctx.send("**ملاحظة: ممنوع الترول لو تترول ماراح تتوثق**")
  time.sleep(3)
  await ctx.send("**ملاحظة 2: إذا عرفت السيرفر من شخص غير فولز قول اسمه او صور حسابة**")
 else:
  return
