...
{prefix}userstatus `تطلع معلومات عضو (لو كان خارج السيرفر استخدم الايدي)`
...
@commands.guild_only()
async def speed(ctx):
 msg=await ctx.send("**سرعة التعديل 0**")
 while True:
  await msg.edit(content="**سرعة التعديل 1**")
  await msg.edit(content="**سرعة التعديل 2**")
  await msg.edit(content="**سرعة التعديل 3**")
