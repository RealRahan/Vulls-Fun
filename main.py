...
badwords=["كس", "سكس", "بورن", "بورن هوب", "طيز", "زب", "قحبة", "bitch", "sex", "porn", "ass", "cock", "dick", "عير", "نيك", "عرص", "منيوك", "طيزي", "طيزك", "كسمك", "مفصخة", "مفصخ", "مثلي", "شاذ", "قي", "قاي", "gay", "عضو ذكري", "قضيب", "منتاك", "يتناك", "بتناك", "كسي", "كسك", "قحاب", "hentai", "هنتاي", "هينتاي", "زبي", "مبعوص", "بعص", "ابعصك", "بتش", "بيتش"]
