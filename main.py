...
async def chad(ctx, member: discord.Member=None):
 ...
 imgs=["https://media.discordapp.net/attachments/989476585323253762/989897013913067540/giga-chad.gif", "https://media.discordapp.net/attachments/989476585323253762/989897014408019978/roblox-gigachad.gif", "https://media.discordapp.net/attachments/989476585323253762/989897014718369862/chad-gigachad_1.gif", "https://media.discordapp.net/attachments/989476585323253762/989897014957465681/gigachad-minecraft-meme.gif", "https://media.discordapp.net/attachments/989476585323253762/989897015481745418/gigachad-chad.gif", "https://media.discordapp.net/attachments/989476585323253762/990263938509864970/gigachad-nightmare315.gif"]
...
#  member=ctx.author
# avatar = member.avatar_url_as(static_format="png")
# os.system(f"wget -O pet.gif https://some-random-api.ml/premium/petpet/?avatar={avatar}&key=eLVPcQUGTkaZy3vktWXXqmnuO")
