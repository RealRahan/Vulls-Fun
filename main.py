...
badwords=["كس", "سكس", "بورن", "بورن هوب", "طيز", "زب", "قحبة", "bitch", "sex", "porn", "ass", "cock", "dick", "عير", "نيك", "عرص", "منيوك", "طيزي", "طيزك", "كسمك", "مفصخة", "مفصخ", "مثلي", "شاذ", "قي", "قاي", "gay", "عضو ذكري", "قضيب"]
...
async def img(ctx,*, search=None):
 ...
 image.set_footer(text="‎‎", icon_url="https://freesvg.org/img/1534129544.png")
